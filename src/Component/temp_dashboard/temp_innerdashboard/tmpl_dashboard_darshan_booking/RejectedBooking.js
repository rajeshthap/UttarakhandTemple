...
const Rejectedbooking = () => {
  ...
  //  Excel Download with styling (no Action)
  const handleDownload = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "Rejected Bookings");

    const wbout = XLSX.write(wb, { bookType: "xlsx", type: "array" });
    saveAs(new Blob([wbout], { type: "application/octet-stream" }), "Rejected_Booking_List.xlsx");
  };
