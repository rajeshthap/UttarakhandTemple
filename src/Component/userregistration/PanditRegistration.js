...
function PanditRegistration() {
  ...
  const poojaOptions = [
  { pooja_name: "Annaprashan Sanskar" },
  { pooja_name: "Satyanarayan" },
  { pooja_name: "Bhoomi" },
  { pooja_name: "Griha Pravesh" },
  { pooja_name: "New Office Opening" },
  { pooja_name: "Vivah (Marriage)" },
  { pooja_name: "Vishwakarma" },
  { pooja_name: "Yagnopavit Sanskar" },
  { pooja_name: "Rudrabhishek" },
  { pooja_name: "Engagement Ceremony (Sagai)" },
  { pooja_name: "Naming Ceremony" },
  { pooja_name: "Ganesh Chaturthi" },
  { pooja_name: "Vehicle / Vahan" },
  { pooja_name: "Mundan Sanskar" },
  { pooja_name: "Navratri Durga" },
  { pooja_name: "Brihaspati Vrat Udyapan" },
  { pooja_name: "Ekadashi Vrat Udyapan" },
  { pooja_name: "Godh Bharai (Baby Shower)" },
  { pooja_name: "Haldi Ceremony" },
  { pooja_name: "Janamdin / Birthday" },
  { pooja_name: "Mahalakshmi" },
  { pooja_name: "Vastu Shanti" },
  { pooja_name: "Vishnu Sahastranam Path" },
  { pooja_name: "Kaal Sarp Dosh Nivaran" },
  { pooja_name: "Office / Business" },
  { pooja_name: "Namakarana" },
  { pooja_name: "Hartalika Teej" },
  { pooja_name: "Karwa Chauth" },
  { pooja_name: "Diwali Lakshmi" },
  { pooja_name: "Dhanteras" },
  { pooja_name: "Vara Mahalakshmi" },
  { pooja_name: "Devi Poojan" },
  { pooja_name: "Kuber" },
  { pooja_name: "Narak Chaturdashi" },
  { pooja_name: "Kali" },
  { pooja_name: "Ganesh Lakshmi" },
  { pooja_name: "Govardhan" },
  { pooja_name: "Annakut" },
  { pooja_name: "Bhai Dooj" },
  { pooja_name: "Chopda" },
  { pooja_name: "Ayush Havan" },
  { pooja_name: "Chandi Path" },
  { pooja_name: "Lakshmi Kubera" },
  { pooja_name: "Navagraha" },
  { pooja_name: "Shuddhikaran" },
  ...
  { pooja_name: "Gayatri Mantra Jaap" },
  { pooja_name: "Santan Gopal Mantra Jaap" },
  { pooja_name: "Shani Dosh Nivaran Jaap" },
  { pooja_name: "Rahu Graha Shanti Mantra Jaap" },
  { pooja_name: "Sampoorna Sunderkand" },
  { pooja_name: "Akhand Ramayana" },
  { pooja_name: "Hanuman Chalisa" },
  { pooja_name: "Bajrang Baan" },
  { pooja_name: "Navchandi" },
  { pooja_name: "Durga Saptashati" },
  { pooja_name: "Kanak Dhara" },
  { pooja_name: "Shri Sukt" },
  { pooja_name: "Lalita Sahasranama" },
  { pooja_name: "Kanakadhara Stotram" },
  { pooja_name: "Pitru Dosh Nivaran" },
  { pooja_name: "Shradh & Karma for Ancestors Peace" },
  { pooja_name: "Barsi" },
  { pooja_name: "Bharani Shradh Pitru Paksha" },
  { pooja_name: "Tripindi Shradha" },
  { pooja_name: "Garud Puran" },
  { pooja_name: "Tarpan Shradh" },
  { pooja_name: "Pind Daan Shradh" }
];
