...
const TempleAccepted = () => {
  ...
  const handleDownload = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "TempleAccepted");
    XLSX.writeFile(wb, "Temple_Accepted_List_Styled.xlsx");
  };
                  ...
                  {filteredRequests.length > 0 ? (
                      ...
                      <tr key={index}>
                        ...
                        <td>
                          ...
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              handleStatusChange(req.temple_id, "rejected")
                            }
                          >
                            Rejected
                          </Button>
                    ...
                    <tr>
                      <td colSpan="8" className="text-center">
                        {loading ? "Loading..." : "No accepted requests found."}
                      </td>
                    </tr>
                  )}
                </tbody>
