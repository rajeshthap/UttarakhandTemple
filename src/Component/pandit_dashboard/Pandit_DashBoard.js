      ...
      <div className="dashboard-wrapper">
        ...
        <main className="main-container">
          <div className="content-box">
                  ...
                  <Card.Body>
                    <div className="d-flex align-items-start justify-content-between gap-1 flex-xxl-nowrap flex-wrap  ">
                      <div>
                        ...
                        <h4 className="fw-medium mb-0">02</h4>
                        <div>
                          <span className="user-span">View Details</span>
                        </div>
                      </div>
                  ...
                  <Card.Body>
                    <div className="d-flex align-items-start justify-content-between gap-1 flex-xxl-nowrap flex-wrap  ">
                      <div>
                        <span className="text-muted d-block mb-1 text-nowrap  user-sub-title">
                          {" "}
                          Reject Pujas Booking
                        </span>{" "}
                        <h4 className="fw-medium mb-0">03</h4>
                        <div>
                          <span className="user-span">View Details</span>
                        </div>
                      </div>
                  ...
                  <Card.Body>
                    <div className="d-flex align-items-start justify-content-between gap-1 flex-xxl-nowrap flex-wrap  ">
                      <div>
                        ...
                        <h4 className="fw-medium mb-0">05</h4>
                        <div>
                          <span className="user-span">View Details</span>
                        </div>
                      </div>
            ...
            <Row>
              <Col lg={8} md={8} sm={12} className=" mt-3"></Col>
              <Col lg={4} md={4} sm={12} className=""></Col>
            </Row>
